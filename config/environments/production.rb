...
S3_ACCESS_KEY_FILENAME = "/u/apps/emmet/shared/s3-keys/aws_access.key"
S3_SECRET_KEY_FILENAME = "/u/apps/emmet/shared/s3-keys/aws_secret.key"
...
POST_LOAD_BLOCKS << Proc.new {
  unless Object.const_defined?(:STORAGE_SERVICE)
    ...
    ::STORAGE_SERVICE = S3StorageService.new("production.emmetlabs.com", access_key, secret_key, {:use_as_domain => false})
